...
# -------------------------
VOC_INTERNAL = ['(+/-)-trans-nerolidol', '(E)-2-hexenal;(Z)-3-hexenal', '(S)-citronellol', '(Z)-3-hexen-1-ol', '(Z)-3-hexenyl acetate', '2-phenylethanol', 'alpha-farnesene', 'alpha-pinene', 'benzaldehyde', 'beta-caryophyllene', 'beta-pinene', 'DEN', 'eucalyptol', 'indole', 'lemonol', 'linalool', 'methyl jasmonate (20180404ATFtest)', 'methyl salicylate', 'nicotine', 'nitric oxide', 'ocimene;Limonene;myrcene', 'Pinenes', 'toluene', 'xylenes + ethylbenzene']
